...
-(id)moduleGUID
{
	return @"82875ab0-6596-4a95-9666-cf4260d6e172";
}
...
-(void)MWBsetLevel: (id)args
{
    [controller doZoomToggle];
...
-(void) MWBenableFlash:(id)args{
    
    [controller toggleTorch];
    
}
-(void)addOverlayView: (id)args{
    [self rememberSelf];
    ENSURE_UI_THREAD(addOverlayView,args);
    ...
    if (overlayProxy != nil)
    {
        ...
        overlay= [overlayProxy view];
        
        //[overlayProxy layoutChildren:NO];
        [TiUtils setView:overlay positionRect:[UIScreen mainScreen].bounds];
    }
...
-(void)startScanning:(id)args
{
    ...
    if(overlay!=nil){
        [controller addOverlayView: overlay];
        [overlay release];
    }
...
// when zoomButton is clicked
-(void)setZoomLevel: (id)args{
